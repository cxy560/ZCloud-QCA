...
#if defined(AR6002_REV7)
extern void txqc_init(void);
extern void txqc_prep_threadx_scheduler(void);
extern int txqc_is_meta_scheduler_activity_pending(void);
extern void txqc_wait_for_activity(void);
...
extern VOID *txqc_pool_start(VOID *pool_start, ULONG pool_size);
extern VOID *txqc_app_entry_get(VOID);
