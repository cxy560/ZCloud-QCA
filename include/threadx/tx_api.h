...
/* Opaque AthOS timer */
typedef unsigned int AR6K_TIMER_SPACE[6];
typedef AR6K_TIMER_SPACE AR6K_timer_t;
#endif /* TXQC_CONFIG_USE_AR6K_TIMER */
...
#if defined(TXQC_CONFIG_USE_AR6K_TIMER)
    AR6K_timer_t        AR6K_timer;
#else /* TXQC_CONFIG_USE_AR6K_TIMER */
